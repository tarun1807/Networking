...
class client:
    ...
    def send_string(self, conn):
        ...
        pkt = packet_conversion.packet_convert(msg, payload, self.server_name, self.server_address, self.client_name, self.address, self.username, self.passwd, "string")
    ...
    def send_txt(self, conn):
        ...
        pkt = packet_conversion.packet_convert(msg, payload, self.server_name, self.server_address, self.client_name, self.address, self.username, self.passwd, f"text|{filename}")
    ...
    def send_image(self, conn):
        ...
        pkt = packet_conversion.packet_convert(msg, payload, self.server_name, self.server_address, self.client_name, self.address, self.username, self.passwd, f"image|{name}")
